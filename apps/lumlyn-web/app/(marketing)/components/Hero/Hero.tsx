      ...
      <div className="relative z-20 mx-auto w-full flex flex-col xl:max-w-[1440px] xl:min-h-[1024px]">
        ...
        >
          ...
          <motion.section className="xl:hidden flex flex-col items-center justify-center gap-3 text-[#111]">
            <motion.h1 className="w-[280px] font-bold text-lg leading-[34px]">{hero.headlineMob}</motion.h1>
            <motion.p className="w-[334px] h-[55px] shrink-o text-center text-base leading-[28px]">{hero.subheadlineMob}</motion.p>
            <motion.button>
              <Button variant="primary" className="!text-[xl] !font-semibold !leading-[24px] mt-5 gap-[10px]" onClick={() => setOpen(true)}>
                {hero.ctaMob}
              </Button>
            </motion.button>
            ...
            <motion.button>
              <div className="w-[300px] h-[56px] shrink-0 justify-center items-center flex flex-col mb-3 rounded-[12px] bg-gradient-to-r from-[#9E8CF6] to-[#C9BDF9] shadow-[0_2px_4px_0_rgba(0,0,0,0.05)]">
                <h2 className="text-[#111] text-sm font-bold leading-[14px]">{hero.comingMob[0].tantrumsTitle}</h2>
                <p className="text-[#111] text-sm font-normal leading-[14px]">{hero.comingMob[0].tantrumsDescr}</p>
              </div>
              <div className="w-[300px] h-[56px] shrink-0 justify-center items-center flex flex-col mb-5 rounded-[12px] bg-gradient-to-r from-[#9E8CF6] to-[#C9BDF9] shadow-[0_2px_4px_0_rgba(0,0,0,0.05)]">
                <h2 className="text-[#111] text-sm font-bold leading-[14px]">{hero.comingMob[1].sleepTitle}</h2>
                <p className="text-[#111] text-sm font-normal leading-[14px]">{hero.comingMob[1].sleepDescr}</p>
              </div>
            </motion.button>
          </motion.section>
